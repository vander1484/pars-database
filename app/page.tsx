  ...
  return (
    <main>
      <section className="hero">
        <nav className="nav">
          <a className="brand" href="/">PARS<span>DATABASE</span></a>
          <div><a href="/players">Players</a><a href="/matches">Matches</a><a href="/seasons">Seasons</a><a href="/records">Records</a></div>
        </nav>
        <div className="heroContent">
          ...
          <form className="search" action="/search"><input name="q" aria-label="Search" placeholder="Search players, matches, seasons..."/><button>Search</button></form>
        </div>
      </section>
