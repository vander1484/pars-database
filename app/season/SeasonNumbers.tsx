 ...
 return <section className="numbersSection" id="numbers">
  ...
  <div className="numbersCanvas">
   ...
   <div className="numberStrip">
    ...
    <div><span>Longest unbeaten</span><strong>{longest}</strong><small>all competitions</small></div>
  ...
  `}</style>
  <style jsx global>{`
   /* Overview is deliberately performance-only. Season totals live in Season in Numbers. */
