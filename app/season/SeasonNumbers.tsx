 ...
 return <section className="numbersSection" id="numbers">
  ...
  <style jsx global>{`
   @media(max-width:650px){
    ...
    .overviewGrid,.performancePanel,.cupGrid,.goalList,.squadTable,.transferColumns,.leagueTable,.dataList{width:100%!important;max-width:100%!important;min-width:0!important;box-sizing:border-box!important}
    ...
    .goalRow{width:100%!important;max-width:100%!important;min-width:0!important;grid-template-columns:26px minmax(0,1fr) 38px!important;gap:.5rem!important;box-sizing:border-box!important}
    .goalRow strong{min-width:0!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important}
    .goalBar{grid-column:2/4!important;width:100%!important;min-width:0!important}
